public class BattleManager_PVP4 : BattleManager
{
    protected override void Child_Initialize()
    {
        ...
        GameManager.Instance.SetUpPlayer(new PlayerInfo(PlayerNumber.Player3, TeamNumber.Team1));
        GameManager.Instance.SetUpPlayer(new PlayerInfo(PlayerNumber.Player4, TeamNumber.Team2));
    }
}